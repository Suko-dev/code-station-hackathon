...
export class RelationIngredientUser1624043266012 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "ingredients" DROP COLUMN "unity_type"`);
        await queryRunner.query(`ALTER TABLE "ingredients" ADD "unit_type" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "ingredients" ADD "userId" character varying`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "ingredients" DROP COLUMN "unit_type"`);
        await queryRunner.query(`ALTER TABLE "ingredients" ADD "unity_type" character varying NOT NULL`);
    }
